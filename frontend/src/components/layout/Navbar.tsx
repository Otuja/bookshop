...
export function Navbar() {
  ...
  if (user?.isAdmin) {
    navLinks.push({ href: "/admin/inventory", label: "Admin" });
  }
              ...
              <AnimatePresence>
                {isUserMenuOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 top-full mt-2 w-48 rounded-xl border bg-card text-card-foreground shadow-lg overflow-hidden z-50"
                  >
                    {user ? (
                      <div className="flex flex-col p-1">
                        ...
                        {user.isAdmin ? (
                           <Link
                            ...
                            className="px-3 py-2 text-sm hover:bg-accent rounded-md transition-colors text-left"
                          >
                            Admin Dashboard
                          </Link>
                        ) : (
                        ...
                        <button
                          ...
                          className="px-3 py-2 text-sm hover:bg-destructive/10 text-destructive rounded-md transition-colors text-left w-full"
                        >
                          Logout
                        </button>
                      </div>
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  <Link
                    href={user ? (user.isAdmin ? "/admin/inventory" : "/dashboard") : "/login"}
                    onClick={() => setIsOpen(false)}
